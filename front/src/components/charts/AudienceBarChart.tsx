...
const COLORS = ['#4ade80','#34d399','#22c55e','#16a34a','#15803d','#166534','#4ade80','#34d399','#22c55e','#16a34a']
    ...
    <div className="space-y-3">
      ...
      <ResponsiveContainer width="100%" height={Math.max(250, data.length * 32)}>
        <BarChart data={data} layout="vertical" margin={{ top: 5, right: 60, left: 10, bottom: 5 }}>
          ...
          <XAxis type="number" tick={{ fontSize: 11, fill: '#6b7280' }} unit="만" />
          ...
          <Tooltip
            ...
            formatter={(v) => [`${Number(v).toLocaleString()}만 명`, '누적 관객수']}
          />
