  ...
  return (
    <div>
      ...
      <p className="text-xs text-gray-400 dark:text-gray-600 mb-4">
        인기도(X) vs 평점(Y) — <span className="text-green-500 font-semibold">●</span> 현재 영화
      </p>
      <ResponsiveContainer width="100%" height={260}>
        <ScatterChart margin={{ top: 10, right: 20, bottom: 20, left: 0 }}>
          <XAxis
            ...
            label={{ value: '인기도', position: 'insideBottom', offset: -10, fill: '#6b7280', fontSize: 11 }}
          />
          <YAxis
            dataKey="y"
            name="평점"
            ...
            tickLine={false}
            axisLine={{ stroke: '#374151' }}
            label={{ value: '평점', angle: -90, position: 'insideLeft', offset: 10, fill: '#6b7280', fontSize: 11 }}
          />
          <ZAxis range={[40, 40]} />
          <Tooltip
