...
export type AiCommentaryPayload =
  ...
  | { type: 'weekly' | 'weekend'; showRange: string; entries: object[]; chartFocus?: ChartFocus }
  | { type: 'trend'; monthly: object[]; seasonal: object[] }

export async function fetchCommentary(payload: AiCommentaryPayload): Promise<string> {
